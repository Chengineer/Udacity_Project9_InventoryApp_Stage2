...
public class bookProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.p9inventoryappstage2/books" will map to the
        ...
        // For example, "content://com.example.android.p9inventoryappstage2/books/3" matches, but
        // "content://com.example.android.p9inventoryappstage2/books" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // For an example URI such as "content://com.example.android.p9inventoryappstage2/books/3",
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        if ((price == null) || (price <= Double.parseDouble("0")) || (Double.toString(price).isEmpty())) {
            throw new IllegalArgumentException("Book requires a valid price");
        }
        // Check that the quantity is valid
        Integer quantity = values.getAsInteger(bookEntry.COLUMN_BOOK_QUANTITY);
        if (((quantity != null) && (quantity < 0)) || (quantity == null) || (Integer.toString(quantity).isEmpty())) {
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link bookEntry#COLUMN_BOOK_TITLE} key is present, check that the title value is not null.
        ...
        // If the {@link bookEntry#COLUMN_BOOK_AUTHOR} key is present, check that the author value is not null.
        ...
        // If the {@link bookEntry#COLUMN_BOOK_QUANTITY} key is present, check that the quantity value is valid.
        if (values.containsKey(bookEntry.COLUMN_BOOK_QUANTITY)) {
            // Check that the quantity is greater or equal to 0
            Integer quantity = values.getAsInteger(bookEntry.COLUMN_BOOK_QUANTITY);
            if (((quantity != null) && (quantity < 0)) || (quantity == null) || (Integer.toString(quantity).isEmpty())) {
                throw new IllegalArgumentException("Book requires a valid quantity");
            }
        }
        // If the {@link bookEntry#COLUMN_BOOK_SUPPLIER_NAME} key is present, check that the supplier name value is not null.
        ...
        // If the {@link bookEntry#COLUMN_BOOK_SUPPLIER_PHONE} key is present, check that the supplier phone number value is not null.
